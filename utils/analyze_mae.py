...
<div class="card full">
  ...
  <p class="note">MAE uses daily Low — this is the worst MTM dip you lived through each day (not intraday tick). Captures real psychological pressure, unlike close-to-close P&amp;L.</p>
</div>
...
<div class="card">
  ...
  <p class="note">Read as: what % of your trades dipped more than X% before closing.</p>
</div>

<div class="card">
  <h2>Key Insight for 2026</h2>
  <table>
    <tr><th>Scenario</th><th>Expectation</th></tr>
    <tr><td>Typical trade dips</td><td style="color:#d97706;font-weight:600">{overall_avg_mae}% before resolving</td></tr>
    <tr><td>Winners dip before winning</td><td style="color:#d97706;font-weight:600">{winner_avg_mae}% avg MAE on winning trades</td></tr>
    <tr><td>Winners peak at</td><td style="color:#16a34a;font-weight:600">+{overall_avg_mfe}% best point</td></tr>
  </table>
  <p class="note">When a current position dips {"within" if abs(overall_avg_mae) < 10 else "close to"} {overall_avg_mae}% from your entry — that is normal historical behaviour, not a system failure. Panic exits here would have cost you the average winner.</p>
</div>
