...
**Supporting files:**
- `utils/generators/generate_index.py` — Slim landing page (cx-rehaul 2026-07-15): ONE hero button (☀️ Open Cockpit) + shared nav + latest-weekly card + 📚 Report Archive (`<details>` groups keeping EVERY dated report reachable). Also writes `data/record.html` via `generate_record.py` (tabs: Perf 2026 / Perf 2024-25 / MAE-MFE / Trader Mirror, lazy iframes).
